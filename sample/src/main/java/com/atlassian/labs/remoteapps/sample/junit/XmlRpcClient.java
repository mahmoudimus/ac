...
public class XmlRpcClient extends XmlRpcParser implements XmlRpcInvocationHandler
{
     ...
     *
     *  @throws redstone.xmlrpc.XmlRpcException One or more of the supplied arguments are unserializable. That is,
     ...
     *
     *  @throws redstone.xmlrpc.XmlRpcException when some IO problem occur.
     */
    ...
    private Object endCall() throws XmlRpcException, XmlRpcFault
    {
        try
        {
            ...
            else
            {
                ...
                final OutputStream connOutputStream = connection.getOutputStream();
                OutputStream output = new BufferedOutputStream(connOutputStream);
                output.write(bytes);
                output.flush();
                output.close();
     ...
     *
     *
     *  @throws java.io.IOException If a socket error occurrs, or if the XML returned is unparseable.
     ...
     *
     *  @throws java.io.IOException If a connection could not be opened. The exception
