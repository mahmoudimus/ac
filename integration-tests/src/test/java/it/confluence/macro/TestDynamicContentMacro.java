...
//                .start();
        ...
        remotePlugin = new ConnectRunner(product.getProductInstance().getBaseUrl(), addonKey)
                ...
                .addModules("dynamicContentMacros",
                        ...
                        dynamicContentMacroById, dynamicContentMacroByHash
                )
                .addModules("staticContentMacros", staticContentMacroById, staticContentMacroByHash)
...
//    }
    ...
    {
        Content page = createPage2(macroKey, "<h1>Hello world</h1>");
        getProduct().viewPage(String.valueOf(page.getId().asLong()));
    ...
    private void testStaticMacro(String macroKey)
    {
        ...
        Content page = createPage2(macroKey, "<h1>" + headingText + "</h1>");
    ...
    private Content createPage2(String macroKey, String macroBody)
    {
