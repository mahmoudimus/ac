...
public class TestProjectAdminTabPanel extends JiraWebDriverTestBase
{
    ...
    {
        final ProjectSummaryPageTab page = loginAndVisit(ConnectTestUserFactory.sysadmin(product), ProjectSummaryPageTab.class, project.getKey());
    ...
    {
        ProjectSummaryPageTab page = loginAndVisit(ConnectTestUserFactory.sysadmin(product), ProjectSummaryPageTab.class, project.getKey());
