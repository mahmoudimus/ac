...
public class TestProjectAdminTabPanel extends JiraWebDriverTestBase
{
    ...
    {
        final ProjectSummaryPageTab page = loginAndVisit(ConnectTestUserFactory.basicUser(product), ProjectSummaryPageTab.class, project.getKey());
    ...
    {
        ProjectSummaryPageTab page = loginAndVisit(ConnectTestUserFactory.basicUser(product), ProjectSummaryPageTab.class, project.getKey());
