...
{
    private static final Logger log = LoggerFactory.getLogger(ConnectCrowdPermissionsImpl.class);
    ...
    @VisibleForTesting
    private ConnectCrowdPermissionsImpl()
    {
        this.hostProperties = null;
        this.userManagementLockService = null;
        this.managedPermissionsService = null;
    }

    @Autowired
    public ConnectCrowdPermissionsImpl(HostProperties hostProperties,
