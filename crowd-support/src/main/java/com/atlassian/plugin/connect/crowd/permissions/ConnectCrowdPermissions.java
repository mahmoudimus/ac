...
public interface ConnectCrowdPermissions {
     ...
     * @return {@link ConnectCrowdPermissions.GrantResult#NO_REMOTE_GRANT_NEEDED} if permissions are not managed remotely,
     * {@link ConnectCrowdPermissions.GrantResult#REMOTE_GRANT_SUCCEEDED} if administer permissions were granted successfully, or
     * {@link ConnectCrowdPermissions.GrantResult#REMOTE_GRANT_FAILED} if granting of administer permissions failed
     */
