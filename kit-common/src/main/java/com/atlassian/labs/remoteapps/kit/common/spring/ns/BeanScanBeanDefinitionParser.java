...
import com.atlassian.labs.remoteapps.kit.common.spring.NamedAnnotationBeanNameGenerator;
...
public class BeanScanBeanDefinitionParser implements BeanDefinitionParser
{
    ...
    private boolean plugins3Available()
    {
        try
        {
            getClass().getClassLoader().loadClass("com.atlassian.labs.remoteapps.api.service.HttpResourceMounter");
            return true;
        }
