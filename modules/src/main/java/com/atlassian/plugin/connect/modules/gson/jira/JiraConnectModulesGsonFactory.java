package com.atlassian.plugin.connect.modules.gson.jira;
 ...
 * @since 1.0
 */
public class JiraConnectModulesGsonFactory
{
    ...
    private static final Type TYPE = new TypeToken<ConnectAddonBean<JiraModuleList>>() {}.getType();
