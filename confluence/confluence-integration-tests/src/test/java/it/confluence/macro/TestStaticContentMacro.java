...
public class TestStaticContentMacro extends AbstractContentMacroTest {
    ...
    public static void startConnectAddon() throws Exception {
        ...
        StaticContentMacroModuleBean hiddenParameterMacro = createHiddenParameterMacro(newStaticContentMacroModuleBean());
        ...
        remotePlugin = new ConnectRunner(product.getProductInstance().getBaseUrl(), "my-plugin")
                ...
                .addRoute("/render-storage-format", resourceServlet("it/confluence/macro/test-static-content-macro.xhtml", "application/xhtml+xml"))
