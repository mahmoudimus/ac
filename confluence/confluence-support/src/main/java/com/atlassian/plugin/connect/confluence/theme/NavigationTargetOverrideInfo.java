...
public enum NavigationTargetOverrideInfo {
    ...
    search("/decorators/main.vmd",
         "velocity/confluence/theme-support/decorators/search.vmd",
         "search",
         "searchv3",
         "success",
         "/velocity/confluence/theme-support/search.vm",
         NavigationTargetName.sitesearch),
