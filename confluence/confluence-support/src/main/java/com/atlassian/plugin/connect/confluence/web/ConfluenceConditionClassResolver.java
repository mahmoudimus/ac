...
public class ConfluenceConditionClassResolver implements ConnectConditionClassResolver
{
    ...
    public List<Entry> getEntries()
    {
        return ImmutableList.of(
                ...
                newEntry("target_user_can_set_status", com.atlassian.confluence.plugin.descriptor.web.conditions.user.TargetUserCanSetStatusCondition.class).build(),
                ...
                newEntry("user_can_update_user_status", com.atlassian.confluence.plugin.descriptor.web.conditions.user.UserCanUpdateUserStatusCondition.class).build(),
