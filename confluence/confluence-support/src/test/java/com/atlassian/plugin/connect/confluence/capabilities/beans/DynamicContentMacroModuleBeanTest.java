...
public class DynamicContentMacroModuleBeanTest
{
    ...
    public void producesCorrectJSON() throws Exception
    {
        ...
        String json = gson.toJson(bean, DynamicContentMacroModuleBean.class);
    ...
    public void producesCorrectBean() throws Exception
    {
        ...
        Gson gson = ConnectModulesGsonFactory.getGson();
        DynamicContentMacroModuleBean deserializedBean = gson.fromJson(json, DynamicContentMacroModuleBean.class);
        DynamicContentMacroModuleBean bean = createBean();
    ...
    {
        DynamicContentMacroModuleBean originalBean = createBean();
        Gson gson = ConnectModulesGsonFactory.getGson();
        String json = gson.toJson(originalBean, DynamicContentMacroModuleBean.class);
        DynamicContentMacroModuleBean deserializedBean = gson.fromJson(json, DynamicContentMacroModuleBean.class);

        assertThat(deserializedBean, SameDeepPropertyValuesAs.sameDeepPropertyValuesAs(originalBean));
    }

    private static DynamicContentMacroModuleBean createBean()
    {
