...
public class BlueprintContextProviderTest {
    ...
    @Mock
    private RemotablePluginAccessorFactory accessorFactory;
    @Mock
    private ContentBodyConversionService converter;
    @Mock
    private UserManager userManager;
    @Mock
    private RemotablePluginAccessor mockAccessor;
    @Mock
    ...
    @Mock
    private Promise<String> mockPromise;
    @Mock
    private BlueprintContext mockContextObj;
