...
import com.atlassian.plugin.connect.modules.beans.builder.PropertyPanelBeanBuilder;
 ...
 * @since 1.0
 */
public class PropertyPanelBean extends BaseModuleBean
{
    /**
    ...
    public PropertyPanelBean(PropertyPanelBeanBuilder builder)
    {
        super(builder);
        init();
    }
    ...
    public static PropertyPanelBeanBuilder newMacroEditorBean()
    {
        return new PropertyPanelBeanBuilder();
    }

    public static PropertyPanelBeanBuilder newMacroEditorBean(PropertyPanelBean defaultBean)
    {
        return new PropertyPanelBeanBuilder(defaultBean);
    }
}
