...
public class ConnectContextParameterMapperModuleDescriptorTest
{

    @Rule
    public ExpectedException expectedException = ExpectedException.none();

    private ConnectContextParameterMapperModuleDescriptor descriptor;
    ...
    public void setUp()
    {
        descriptor = new ConnectContextParameterMapperModuleDescriptor(ModuleFactory.LEGACY_MODULE_FACTORY);
    }
    ...
    {
        Element element = new DOMElement("connect-context-parameter-mapper");
