...
public class JwtSigningRemotablePluginAccessorTest extends BaseSigningRemotablePluginAccessorTest
{
    ...
    {
        assertThat(createRemotePluginAccessor()
                           .executeAsync(HttpMethod.GET, GET_PATH, GET_PARAMS_STRING_ARRAY, UNAUTHED_GET_HEADERS, HttpContentRetriever.EMPTY_STREAM).get(),
    ...
    {
        Map<String, String> headers = new HashMap<>(preSigningHeaders);
    ...
    private RemotablePluginAccessor createRemotePluginAccessor(final String baseUrl, UserManager userManager)
    {
        ...
        Supplier<URI> baseUrlSupplier = () -> URI.create(baseUrl);
