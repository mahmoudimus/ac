...
public class AddonPropertiesResource {
     ...
     * @response.representation.200.doc A list of property keys with links to themselves.
     * @response.representation.401.doc Request without credentials or with invalid credentials, e.g. by an uninstalled add-on.
     * @response.representation.404.doc Request issued by a user with insufficient credentials, e.g. for an add-on's data by anyone but the add-on itself, or for a plugin that does not exist.
     */
    @GET
     ...
     * @return a Response containing a list of properties or an error code with message.
     * @response.representation.200.mediaType application/json
     * @response.representation.200.doc The property containing key, value and link to self.
     * @response.representation.400.doc Property key longer than 127 characters.
     * @response.representation.401.doc Request without credentials or with invalid credentials, e.g. by an uninstalled add-on.
     * @response.representation.404.doc Request to get a property that does not exist.
     * @response.representation.404.doc Request issued by a user with insufficient credentials, e.g. for an add-on's data by anyone but the add-on itself, or for a plugin that does not exist.
     */
    @GET
    @Path("{propertyKey}")
     ...
     * @return a Response containing a list of properties or an error code with message.
     * @response.representation.200.mediaType application/json
     * @response.representation.200.doc Property has been updated.
     * @response.representation.201.mediaType application/json
     * @response.representation.201.doc Property has been created.
     * @response.representation.400.doc Property key longer than 127 characters.
     * @response.representation.401.doc Request without credentials or with invalid credentials, e.g. by an uninstalled add-on.
     * @response.representation.404.doc Request to get a property that does not exist.
     * @response.representation.404.doc Request issued by a user with insufficient credentials, e.g. for an add-on's data by anyone but the add-on itself, or for a plugin that does not exist.
     ...
     * @param servletRequest the HTTP servlet request
     * @return a Response containing a list of properties or an error code with message.
     * @response.representation.204.doc Nothing is returned on success.
     * @response.representation.400.doc Property key longer than 127 characters.
     * @response.representation.401.doc Request without credentials or with invalid credentials, e.g. by an uninstalled add-on.
     * @response.representation.404.doc Request to get a property that does not exist.
     * @response.representation.404.doc Request issued by a user with insufficient credentials, e.g. for an add-on's data by anyone but the add-on itself, or for a plugin that does not exist.
