...
public class ConfluenceRestScopesTest extends RequestInApiScopeTest
{
    public ConfluenceRestScopesTest(AddOnScopeManager scopeManager, TestPluginInstaller testPluginInstaller)
    {
