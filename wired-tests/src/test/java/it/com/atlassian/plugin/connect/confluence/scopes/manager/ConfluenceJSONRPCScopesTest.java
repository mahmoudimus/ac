...
public class ConfluenceJSONRPCScopesTest extends RequestInApiScopeTest
{
    public ConfluenceJSONRPCScopesTest(AddOnScopeManager scopeManager, TestPluginInstaller testPluginInstaller)
    {
