...
public class JiraRestScopesTest extends RequestInApiScopeTest
{
    public JiraRestScopesTest(AddOnScopeManager scopeManager, TestPluginInstaller testPluginInstaller)
    {
