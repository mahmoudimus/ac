...
public abstract class AbstractJiraPermissionScopeTest
{
    ...
    private UserProfile getAddOnUserProfile() throws ConnectAddOnUserInitException
    {
        return connectUserService.getOrCreateAddonUser(ADDON_KEY, "It's a PROJECT_ADMIN-scoped add-on for tests!");
    }

    protected ApplicationUser getAddOnUser() throws ConnectAddOnUserInitException
    {
        UserProfile profile = getAddOnUserProfile();
        return userManager.getUserByName(profile.getUsername());
    }
