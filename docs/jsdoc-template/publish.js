...
function generate( docType, title, docs, filename, resolveLinks ) {
    ...
    fs.writeFileSync( outpath.replace(/\.html/, '.md'), html, 'utf8' );
}
...
//  var globalUrl = helper.getUniqueFilename( 'global' );
    ...
    view.productKey = conf.productKey || ""
...
*/
    ...
    */
    ...
    fs.writeFileSync( path.join( outdir, '_data.json' ), JSON.stringify(generateNavigationJSON()), 'utf8' );
