 ...
 * Add new `addon_is_licensed` condition to JIRA and Confluence [AC-1641](https://ecosystem.atlassian.net/browse/AC-1641)
 * Allow multiple dialogs to be open at the same time [ACJS-91](https://ecosystem.atlassian.net/browse/ACJS-91)
 * JIRA: Add plugin point to configure board page [ACJIRA-593](https://ecosystem.atlassian.net/browse/ACJIRA-593)
