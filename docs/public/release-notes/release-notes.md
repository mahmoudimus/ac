...
## [1.1.61](../release-notes/1-1-0.html#1.1.61)
 * Fixed add-on admin screen failing when add-ons with invalid descriptors already installed [AC-1777](https://ecosystem.atlassian.net/browse/AC-1777)
