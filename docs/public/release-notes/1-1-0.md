...
<table class="aui issue-table">
    ...
    <tbody>
        <tr>
            ...
            <td><a href="https://ecosystem.atlassian.net/browse/ACDEV-1997">ACDEV-1997</a></td>
            <td>Move Confluence-specific code to separate Maven module</td>
        </tr>
        <tr>
            <td><span class="aui-icon aui-icon-small aui-icon-success">Improvement</span></td>
            <td><a href="https://ecosystem.atlassian.net/browse/ACDEV-2052">ACDEV-2052</a></td>
            <td>Rewrite conditions documentation to focus on use cases</td>
        </tr>
        <tr>
            <td><span class="aui-icon aui-icon-small aui-icon-warning">Bug</span></td>
            <td><a href="https://ecosystem.atlassian.net/browse/ACDEV-2069">ACDEV-2069</a></td>
            <td>Compilation error in PluginForTests against JIRA 7</td>
        </tr>
        <tr>
            <td><span class="aui-icon aui-icon-small aui-icon-warning">Bug</span></td>
            <td><a href="https://ecosystem.atlassian.net/browse/ACJIRA-425">ACJIRA-425</a></td>
            <td>Integration test TestDashboardItem#testDashboardItemReactsToEditClick() fails consistently on JIRA 7</td>
        </tr>
        <tr>
            <td><span class="aui-icon aui-icon-small aui-icon-success">Improvement</span></td>
            <td><a href="https://ecosystem.atlassian.net/browse/ACDEV-2051">ACDEV-2051</a></td>
            <td>Change product scope unit tests to wired</td>
        </tr>
        <tr>
            <td><span class="aui-icon aui-icon-small aui-icon-success">Improvement</span></td>
            <td><a href="https://ecosystem.atlassian.net/browse/ACDEV-2058">ACDEV-2058</a></td>
            <td>Clover is slowing down Wired/Lifecycle profile builds</td>
        </tr>
    </tbody>
</table>
