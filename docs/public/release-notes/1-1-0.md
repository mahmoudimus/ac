...
* Client-side JWT refresh fails for users with [UTF-8](https://ecosystem.atlassian.net/browse/UTF-8) characters in the display name [ACJS-36](https://ecosystem.atlassian.net/browse/ACJS-36)
