...
<table class="aui issue-table">
      ...
      <tbody>
          ...
          <tr>
              ...
              <td>Fixed: web-sections which rely on add-on-provided web-items fail to register</td>
          </tr>
          <tr>
              <td></td>
          ...
          <tr>
              ...
              <td>Whitelisted Confluence Questions context params for webitems and webpanels</td>
          </tr>
          <tr>
              <td></td>
