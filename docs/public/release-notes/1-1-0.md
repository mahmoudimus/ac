...
<table class="aui issue-table">
    ...
    <tbody>
        <tr>
            ...
            <td><a href="https://ecosystem.atlassian.net/browse/AC-1777">AC-1777</a></td>
            <td>Fixed add-on admin screen failing when add-ons with invalid descriptors already installed</td>
        </tr>
    </tbody>
</table>
