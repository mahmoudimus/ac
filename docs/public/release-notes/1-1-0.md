...
<table class="aui issue-table">
  ...
  <tbody>
      ...
      <tr>
          <td><span class="aui-icon aui-icon-small aui-icon-warning">Bug</span></td>
          <td><a href="https://ecosystem.atlassian.net/browse/AC-1232">AC-1232</a></td>
          <td>Gantt Cloud Add-on no longer authenticates correctly with JIRA Rest API</td>
      </tr>
      <tr>
          <td><span class="aui-icon aui-icon-small aui-icon-warning">Bug</span></td>
          <td><a href="https://ecosystem.atlassian.net/browse/AC-1228">AC-1228</a></td>
          <td>Cannot insert a macro with a custom editor on a new Confluence page</td>
      </tr>
      <tr>
          <td><span class="aui-icon aui-icon-small aui-icon-warning">Bug</span></td>
