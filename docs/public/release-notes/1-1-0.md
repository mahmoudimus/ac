...
<table class="aui issue-table">
    ...
    <tbody>
        ...
        <tr>
            <td><span class="aui-icon aui-icon-small aui-icon-warning">Bug</span></td>
            <td><a href="https://ecosystem.atlassian.net/browse/AC-1799">AC-1799</a></td>
            <td>Canonical request calculation for requests to add-ons does not respect encoding of path</td>
        </tr>
    </tbody>
</table>
