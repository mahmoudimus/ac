...
#### JIRA
<pre><code data-lang="text">atlas-run-standalone --product jira --version 6.3-OD-06-017 --bundled-plugins com.atlassian.plugins:atlassian-connect-plugin:1.1.0-beta.2,com.atlassian.jwt:jwt-plugin:1.1.0,com.atlassian.bundles:json-schema-validator-atlassian-bundle:1.0.1 --jvmargs -Datlassian.upm.on.demand=true</code></pre>
