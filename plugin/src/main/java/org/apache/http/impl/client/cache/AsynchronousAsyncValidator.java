...
class AsynchronousAsyncValidator {
     ...
     */
    public AsynchronousAsyncValidator(CachingHttpAsyncClient cachingClient,
            CacheConfig config) {
        this(cachingClient,
    ...
    public synchronized void revalidateCacheEntry(HttpHost target,
        ...
        if (!this.queued.contains(uri)) {
            AsynchronousAsyncValidationRequest asyncRevalidationRequest =
                new AsynchronousAsyncValidationRequest(this, this.cachingAsyncClient, target,
