...
import com.atlassian.labs.remoteapps.plugin.module.util.redirect.RedirectServlet;
...
/**
 * A remote search request review that will do an html redirect to the remote app
 */
