...
@Component
public class RemotablePluginAccessorFactory implements DisposableBean
{
    ...
    @Autowired
    public RemotablePluginAccessorFactory(ApplicationLinkAccessor applicationLinkAccessor,
