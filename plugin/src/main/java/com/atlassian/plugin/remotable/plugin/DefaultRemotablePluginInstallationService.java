...
import com.atlassian.plugin.remotable.plugin.installer.SchemeDelegatingRemotePluginInstaller;
...
{
    private final SchemeDelegatingRemotePluginInstaller remotePluginInstaller;
    ...
    public DefaultRemotablePluginInstallationService(SchemeDelegatingRemotePluginInstaller remotePluginInstaller,
                                                                                            ...
                                                                                            InstallationFailedException
    {
        ...
        try
        {
            String appKey = remotePluginInstaller.install(username, parsedRegistrationUri, registrationSecret,
                    stripUnknownModules, new RemotePluginInstaller.KeyValidator()
               {
                   @Override
