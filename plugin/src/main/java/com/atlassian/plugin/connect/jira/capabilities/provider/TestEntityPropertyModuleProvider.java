...
@JiraComponent
public class TestEntityPropertyModuleProvider implements TestConnectModuleProvider
{
    ...
    @Override
    public List<ModuleDescriptor> provideModules(final ConnectModuleProviderContext moduleProviderContext, Plugin plugin, final List<Module> modules)
    {
        return null;
