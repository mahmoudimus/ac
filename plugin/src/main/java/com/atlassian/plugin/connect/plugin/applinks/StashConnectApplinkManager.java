...
@StashComponent
public class StashConnectApplinkManager extends DefaultConnectApplinkManager implements ConnectApplinkManager
{
    private static final Logger log = LoggerFactory.getLogger(StashConnectApplinkManager.class);
    public static final String SYSADMIN = "sysadmin";

    @Inject
    public StashConnectApplinkManager(MutatingApplicationLinkService applicationLinkService, TypeAccessor typeAccessor,
