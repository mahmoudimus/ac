...
import com.atlassian.plugin.connect.plugin.service.ILegacyAddOnIdentifierService;
...
@Named
public class XmlPluginAutoUninstallerImpl implements LifecycleAware, XmlPluginAutoUninstaller
{
    private final PluginAccessor pluginAccessor;
    private final ILegacyAddOnIdentifierService legacyAddOnIdentifierService;
    private static final Logger log = LoggerFactory.getLogger(XmlPluginAutoUninstallerImpl.class);
    private final PluginController pluginController;
    private final OAuthLinkManager oAuthLinkManager;
    private final ConnectApplinkManager connectApplinkManager;

    @Inject
    public XmlPluginAutoUninstallerImpl(PluginAccessor pluginAccessor,
                                        ILegacyAddOnIdentifierService legacyAddOnIdentifierService,
