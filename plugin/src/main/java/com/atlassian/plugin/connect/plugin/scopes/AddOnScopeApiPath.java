...
public interface AddOnScopeApiPath
{
    ...
    void addTo(Collection<RestApiScopeHelper.RestScope> restResources,
               Collection<RpcEncodedSoapApiScopeHelper> soapResources,
               Collection<JsonRpcApiScopeHelper> jsonResources,
    ...
    static class RestApiPath implements AddOnScopeApiPath
    {
        ...
        @Override
        public void addTo(Collection<RestApiScopeHelper.RestScope> restResources, Collection<RpcEncodedSoapApiScopeHelper> soapResources, Collection<JsonRpcApiScopeHelper> jsonResources, Collection<PathScopeHelper> paths)
        {
