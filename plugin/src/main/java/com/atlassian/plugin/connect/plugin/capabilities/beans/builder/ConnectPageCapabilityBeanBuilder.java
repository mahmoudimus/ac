...
public class ConnectPageCapabilityBeanBuilder<T extends ConnectPageCapabilityBeanBuilder, B extends ConnectPageCapabilityBean> extends BeanWithKeyParamsAndConditionsBuilder<T, B>
{
    private String url;
    ...
    public ConnectPageCapabilityBeanBuilder(ConnectPageCapabilityBean defaultBean)
    {
        super(defaultBean);
    ...
    public ConnectPageCapabilityBeanBuilder()
    {
    }
    ...
    public B build()
    {
        return (B) new ConnectPageCapabilityBean(this);
    }
