...
{
    private static final String DESCRIPTION = "Ensures only connect add-ons are in the atlassian-addons group";
    ...
    public HealthStatus check()
    {
        ...
        try
        {
            ...
            return new DefaultHealthStatus(isHealthy, reason, time, com.atlassian.healthcheck.core.Application.Plugin, HealthStatusExtended.Severity.CRITICAL, "");
        }
        catch (ApplicationNotFoundException e)
        {
            return new DefaultHealthStatus(false, "Could not find application " + e.getApplicationName(),
                    time, com.atlassian.healthcheck.core.Application.Plugin, HealthStatusExtended.Severity.CRITICAL, null);
        }
    }
}
