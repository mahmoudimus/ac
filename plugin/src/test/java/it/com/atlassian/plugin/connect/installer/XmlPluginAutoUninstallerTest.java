...
import com.atlassian.plugin.connect.plugin.integration.plugins.XmlPluginAutoUninstaller;
...
public class XmlPluginAutoUninstallerTest
{
    ...
    private final XmlPluginAutoUninstaller xmlPluginAutoUninstaller;
    ...
    public XmlPluginAutoUninstallerTest(TestPluginInstaller testPluginInstaller,
                                        ...
                                        XmlPluginAutoUninstaller xmlPluginAutoUninstaller,
                                        PluginAccessor pluginAccessor)
    {
        this.testPluginInstaller = testPluginInstaller;
        this.testAuthenticator = testAuthenticator;
        this.connectApplinkManager = connectApplinkManager;
        this.xmlPluginAutoUninstaller = xmlPluginAutoUninstaller;
    ...
    public void setUp() throws IOException, URISyntaxException, OAuthException
    {
        ...
        xmlPluginAutoUninstaller.onStart();
    }
