...
import com.atlassian.plugin.connect.modules.gson.confluence.ConfluenceConnectModulesGsonFactory;
...
public class StaticContentMacroModuleBeanTest
{
    ...
    public void producesCorrectJSON() throws Exception
    {
        ...
        Gson gson = ConfluenceConnectModulesGsonFactory.getGson();
    ...
    public void producesCorrectBean() throws Exception
    {
        ...
        ConnectAddonBean<ConfluenceModuleList> deserializedBean = ConfluenceConnectModulesGsonFactory.addonFromJsonWithI18nCollector(json, null);
        ConnectAddonBean bean = createBean();
    ...
    private static ConnectAddonBean createBean()
    {
        return newConnectAddonBean()
                ...
                .withModuleList(ConfluenceModuleList.newModuleList()
                                .withStaticContentMacros(newStaticContentMacroModuleBean()
