...
import com.atlassian.plugin.connect.plugin.request.CachingHttpContentRetriever;
import com.atlassian.plugin.connect.plugin.request.ConnectHttpClientFactory;
import com.atlassian.plugin.connect.plugin.request.DefaultRemotablePluginAccessorFactoryImpl;
import com.atlassian.plugin.connect.plugin.request.NoAuthRemotablePluginAccessor;
...
public class DefaultRemotablePluginAccessorFactoryTest
{
    ...
    @Mock private ConnectAddonAccessor addonAccessor;

    private DefaultRemotablePluginAccessorFactoryImpl factory;
    ...
    public void beforeEachTest() throws ExecutionException, InterruptedException
    {
        ...
        factory = new DefaultRemotablePluginAccessorFactoryImpl(connectApplinkManager, descriptorRegistry, oAuthLinkManager, mockCachingHttpContentRetriever(), pluginAccessor, applicationProperties, eventPublisher,jwtService, consumerService, userManager, addonAccessor);
    }
