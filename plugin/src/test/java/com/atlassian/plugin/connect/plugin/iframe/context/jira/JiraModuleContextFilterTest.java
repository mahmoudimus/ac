...
import static com.atlassian.plugin.connect.plugin.iframe.context.jira.JiraModuleContextFilter.COMPONENT_ID;
import static com.atlassian.plugin.connect.plugin.iframe.context.jira.JiraModuleContextFilter.ISSUE_ID;
import static com.atlassian.plugin.connect.plugin.iframe.context.jira.JiraModuleContextFilter.ISSUE_KEY;
import static com.atlassian.plugin.connect.plugin.iframe.context.jira.JiraModuleContextFilter.POSTFUNCTION_CONFIG;
import static com.atlassian.plugin.connect.plugin.iframe.context.jira.JiraModuleContextFilter.POSTFUNCTION_ID;
import static com.atlassian.plugin.connect.plugin.iframe.context.jira.JiraModuleContextFilter.PROJECT_ID;
import static com.atlassian.plugin.connect.plugin.iframe.context.jira.JiraModuleContextFilter.PROJECT_KEY;
import static com.atlassian.plugin.connect.plugin.iframe.context.jira.JiraModuleContextFilter.VERSION_ID;
