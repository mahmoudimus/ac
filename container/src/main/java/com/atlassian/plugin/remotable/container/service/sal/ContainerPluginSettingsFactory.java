 ...
 */
public class ContainerPluginSettingsFactory implements PluginSettingsFactory
{
    private static final Logger log = Logger.getLogger(ContainerPluginSettingsFactory.class);
    private final Properties properties;
    private final File file;

    public ContainerPluginSettingsFactory()
    {
        File file = null;
    ...
    public PluginSettings createSettingsForKey(String key)
    {
        ...
        return new ContainerPluginSettings(new SettingsMap(key));
    }
