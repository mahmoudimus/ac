...
public class InlineConditionResolverJiraWiredTest
{
    ...
    public InlineConditionResolverJiraWiredTest(final InlineConditionResolver inlineConditionResolver, final WebFragmentModuleContextExtractor extractor, final TestAuthenticator testAuthenticator, final JiraTestUtil jiraTestUtil, final VoteService voteService, final SubTaskManager subTaskManager, final UserIssueHistoryManager historyManager)
    {
