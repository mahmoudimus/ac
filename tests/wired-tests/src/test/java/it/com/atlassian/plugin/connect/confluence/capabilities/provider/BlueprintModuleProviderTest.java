package it.com.atlassian.plugin.connect.confluence.capabilities.provider;
...
public class BlueprintModuleProviderTest
{
    ...
    public void createBlueprintModules() throws Exception
    {
        ...
        try
        {
            ...
            List<ModuleDescriptor> descriptors = blueprintModuleProvider.createPluginModuleDescriptors(newArrayList(bean), plugin, moduleProviderContext);
