...
/**
 * Default implementation of an {@link org.apache.http.conn.routing.HttpRoutePlanner}.
...
public class ProxySelectorAsyncRoutePlanner implements HttpRoutePlanner
{

    /** The scheme registry. */
    protected final AsyncSchemeRegistry schemeRegistry; // @ThreadSafe
     ...
     */
    public ProxySelectorAsyncRoutePlanner(AsyncSchemeRegistry schreg,
        ...
        throws HttpException
    {
        ...
        final AsyncScheme schm =
            this.schemeRegistry.getScheme(target.getSchemeName());
        // as it is typically used for TLS/SSL, we assume that
        // a layered scheme implies a secure connection

        // THIS WAS CHANGED FROM schm.isLayered()
        final boolean secure = "https".equals(schm.getName());// .getLayeringStrategy().isSecure();
