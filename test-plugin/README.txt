Standalone test Atlassian Remote App

This is a standalone, test remote app used for testing Remote Apps features.
...
To run the app, execute the standalone jar:
  java -jar target/remoteapps-test-plugin-VERSION-standalone.jar APP_KEY HOST_BASE_URL APP_BASE_URL PORT
...
world, to be embedded into the remoteapps.jira.com JIRA instance:
  java -jar target/remoteapps-test-plugin-VERSION-standalone.jar myAppKey https://remoteapps.jira.com https://mydomain.com 5432
