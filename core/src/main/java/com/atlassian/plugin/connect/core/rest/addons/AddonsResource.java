...
import com.atlassian.plugin.connect.core.rest.AddonOrSysadminOnlyResourceFilter;
import com.atlassian.plugin.connect.core.rest.RestResult;
import com.atlassian.plugin.connect.core.rest.data.RestAddon;
import com.atlassian.plugin.connect.core.rest.data.RestAddonLicense;
import com.atlassian.plugin.connect.core.rest.data.RestAddons;
import com.atlassian.plugin.connect.core.rest.data.RestContact;
import com.atlassian.plugin.connect.core.rest.data.RestHost;
import com.atlassian.plugin.connect.core.rest.data.RestInternalAddon;
import com.atlassian.plugin.connect.core.rest.data.RestLimitedAddon;
import com.atlassian.plugin.connect.core.rest.data.RestMinimalAddon;
import com.atlassian.plugin.connect.core.rest.data.RestNamedLink;
import com.atlassian.plugin.connect.core.rest.data.RestRelatedLinks;
...
import static com.atlassian.plugin.connect.core.rest.ConnectRestConstants.ADDON_KEY_PATH_PARAMETER;
