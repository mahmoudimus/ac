package com.atlassian.plugin.connect.core;
...
import com.atlassian.plugin.connect.core.util.ConfigurationUtils;
...
public class JwtAuthorizationGenerator implements ReKeyableAuthorizationGenerator
{
    ...
    public String generate(HttpMethod httpMethod, URI url, Map<String, String[]> parameters, String secret)
    {
        ...
        return HttpRequests.JWT_AUTH_HEADER_PREFIX + encodeJwt(httpMethod, url, addOnBaseUrl, parameters, null, consumerService.getConsumer().getKey(), jwtService, secret);
    }
