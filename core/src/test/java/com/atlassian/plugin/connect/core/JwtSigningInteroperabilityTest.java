...
public class JwtSigningInteroperabilityTest
{
    ...
    public void setup()
    {
        when(consumerService.getConsumer()).thenReturn(Consumer.key("jira:1234-5678-9000").name("whatever").signatureMethod(Consumer.SignatureMethod.HMAC_SHA1).publicKey(DummyPublicKey.EMPTY).build());
