...
import com.atlassian.plugin.connect.core.OAuthLinkManager;
...
public class DefaultConnectApplinkManagerTest
{
    ...
    private MutableApplicationLink createAppLink()
    {
        ...
        when(applicationLinkService.addApplicationLink(Matchers.any(ApplicationId.class), Matchers.any(ApplicationType.class), Matchers.any(ApplicationLinkDetails.class))).thenReturn(appLink);
