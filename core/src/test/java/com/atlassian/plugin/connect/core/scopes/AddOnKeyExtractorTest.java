...
import com.atlassian.plugin.connect.core.capabilities.JsonConnectAddOnIdentifierService;
import com.atlassian.plugin.connect.core.util.security.DummyPublicKey;
...
public class AddOnKeyExtractorTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        when(consumerService.getConsumer()).thenReturn(Consumer.key(THIS_ADD_ON_KEY).name("whatever").signatureMethod(Consumer.SignatureMethod.HMAC_SHA1).publicKey(DummyPublicKey.EMPTY).build());
