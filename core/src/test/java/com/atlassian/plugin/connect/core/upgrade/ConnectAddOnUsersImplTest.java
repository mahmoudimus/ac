package com.atlassian.plugin.connect.core.upgrade;
...
public class ConnectAddOnUsersImplTest
{
            ...
            throws ApplicationNotFoundException
    {
        ...
        MatcherAssert.assertThat(users, IsIterableWithSize.<User>iterableWithSize(1));
        MatcherAssert.assertThat(users, contains(hasName("addon_rad-jira-addon")));
    }
            ...
            throws ApplicationNotFoundException
    {
        ...
        MatcherAssert.assertThat(users, IsIterableWithSize.<User>iterableWithSize(2));
        MatcherAssert.assertThat(users, contains(hasName("addon_rad-jira-addon"), hasName("addon_rad-confluence-addon")));
    }
