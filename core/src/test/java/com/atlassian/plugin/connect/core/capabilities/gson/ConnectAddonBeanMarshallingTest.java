package com.atlassian.plugin.connect.core.capabilities.gson;
...
public class ConnectAddonBeanMarshallingTest
{
    ...
    {
        String json = TestFileReader.readAddonTestFile("addonNoCapabilities.json");
    ...
    {
        String json = TestFileReader.readAddonTestFile("addonExtraValue.json");
    ...
    {
        String json = TestFileReader.readAddonTestFile("addonSingleCapability.json");
    ...
    {
        String json = TestFileReader.readAddonTestFile("addonMultipleCapabilities.json");
    ...
    {
        String json = TestFileReader.readAddonTestFile("singleScope.json");
        ConnectAddonBean addOn = ConnectModulesGsonFactory.getGson().fromJson(json, ConnectAddonBean.class);
    ...
    {
        String json = TestFileReader.readAddonTestFile("multipleScopes.json");
        ConnectAddonBean addOn = ConnectModulesGsonFactory.getGson().fromJson(json, ConnectAddonBean.class);
    ...
    public void badScopeName() throws IOException
    {
        ...
        String json = TestFileReader.readAddonTestFile("badScopeName.json");
        ConnectAddonBean addOn = ConnectModulesGsonFactory.getGson().fromJson(json, ConnectAddonBean.class);
