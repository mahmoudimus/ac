...
public class JwtAuthorizationGeneratorTest
{
    ...
    public void beforeEachTest()
    {
        ...
        when(consumerService.getConsumer()).thenReturn(Consumer.key("whatever").name("whatever").signatureMethod(Consumer.SignatureMethod.HMAC_SHA1).publicKey(DummyPublicKey.EMPTY).build());
