...
# 2. Do "ruby od_connect_mass_installer.rb" and it will install all available JIRA and Confluence connect add-ons


require 'rest-client'

INSTANCE_BASE_URL = "https://ac-xml-test.jira-dev.com"
USERNAME = "admin"
...
# puts "JIRA Add-ons:"
# jira_add_ons.each{|add_on| puts "#{add_on[:name]} – #{add_on[:descriptor]}"}

# puts "Confluence Add-ons:"
# confluence_add_ons.each{|add_on| puts "#{add_on[:name]} – #{add_on[:descriptor]}"}
