...
public class FileRepository extends AbstractRepository
{
     ...
     */
    public FileRepository(String path, File homeDir) throws IOException
    {
     ...
     * @throws java.io.IOException if canonical path couldn't be resolved
     */
    public FileRepository(File dir, File homeDir) throws IOException
    {
        this(dir, homeDir, null);
    }
     ...
     * @throws java.io.IOException if canonical path couldn't be resolved
     */
    protected FileRepository(File dir, File homeDir, FileRepository parent) throws IOException
    {
    ...
    public AbstractRepository createChildRepository(String name) throws IOException
    {
        ...
        return new FileRepository(f, homeDir, this);
    }
    ...
    public AbstractRepository getParentRepository()
    {
        if (parent == null)
        {
            ...
            try
            {
                ...
                if (repo == null)
                {
                    repo = new FileRepository(directory.getParentFile(), homeDir);
    ...
    protected Resource lookupResource(String name) throws IOException
    {
        ...
        if (res == null)
        {
            res = new FileResource(new File(directory, name), homeDir, this);
